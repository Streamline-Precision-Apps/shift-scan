...
import {
  getMechanicLogsService,
  createMechanicLogService,
  updateMechanicLogService,
  deleteMechanicLogService,
  getMechanicLogService,
} from "../services/mechanicService.js";

export async function getMechanicLogsController(
  req: Express.Request,
...
export async function getMechanicLogController(
  req: Express.Request,
  res: Express.Response
) {
  // Implementation for getting mechanic logs
...
export async function createMechanicProjectController(
  req: Express.Request,
  res: Express.Response
) {
  try {
...
export async function updateMechanicProjectController(
  req: Express.Request,
  res: Express.Response
) {
  try {
    ...
    if (equipmentId) updatePayload.equipmentId = equipmentId;
    if (hours !== undefined) updatePayload.hours = Number(hours);
...
export async function deleteMechanicProjectController(
  req: Express.Request,
  res: Express.Response
) {
  try {
