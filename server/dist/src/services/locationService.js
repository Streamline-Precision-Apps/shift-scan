...
export async function fetchLatestLocation(userId, date = new Date()) {
...
export async function fetchLocationHistory(userId, date = new Date()) {
    const { startOfDay, endOfDay } = getDayRange(date);
...
export async function fetchAllUsersLatestLocations(date = new Date()) {
    try {
        const { startOfDay, endOfDay } = getDayRange(date);
...
export async function saveUserClockInLocation(userId, sessionId, coords, device) {
    try {
