...
<<<<<<< HEAD
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="text-xs text-center">{truckName || "-"}</div>
            );
        },
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="text-xs text-center">{trailerName || "-"}</div>
            );
        },
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="text-xs text-center">{trailerType || "-"}</div>
            );
        },
    },
    {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="text-xs text-center">
                    {Array.isArray(stateMileages) &&
                    stateMileages.length > 0 ? (
                        <HoverCard>
                            <HoverCardTrigger asChild>
                                <span className="cursor-pointer underline text-blue-600">
