...
function Checkbox({ className, color = "primary", ...props }: CheckboxProps) {
  const colorClasses =
    color === "green"
      ? "peer border-input dark:bg-input/30 data-[state=checked]:bg-green-500 dark:data-[state=checked]:bg-green-500 data-[state=checked]:text-primary-foreground data-[state=checked]:border-green-600 focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-sm border shadow-xs transition-shadow outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50"
