...
export default function DynamicForm({
    ...
    // State variables
    const [formData, setFormData] = useState<FormIndividualTemplate | null>(
        null
    );
        ...
        const fetchAllData = async () => {
            ...
            try {
                ...
                if (endpoints.managerApproval) {
                    fetchPromises.push(
                        apiRequest(endpoints.managerApproval, "GET")
                    );
                }
                ...
                if (submissionData) {
                    ...
                    const legacyTemplate =
                        convertToLegacyFormTemplate(formData);
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (result && formData.isApprovalRequired) {
                await apiRequest("/api/notifications/send-multicast", "POST", {
