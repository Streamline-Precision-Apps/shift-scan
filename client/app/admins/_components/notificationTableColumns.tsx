...
import {
    markBrokenEquipmentNotificationsAsRead,
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button
                                        ...
                                        onClick={async () => {
                                            try {
                                                // Extract timesheet ID from referenceId
                                                const timesheetId =
                                                ...
                                                if (result.resolved) {
                                                    // Timesheet already approved/rejected, remove from list
                                                    setData((prev) =>
                                                        prev?.filter(
                                                            (n) =>
                                                                n.id !==
                                                ...
                                                console.error(
                                                    "Error handling timecard notification:",
                                                    error
                                                );
