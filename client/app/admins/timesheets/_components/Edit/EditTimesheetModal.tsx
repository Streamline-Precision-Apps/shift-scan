...
export const EditTimesheetModal: React.FC<EditTimesheetModalProps> = ({
    ...
    const [originalForm, setOriginalForm] = useState<TimesheetData | null>(
        null
    );
        ...
        setCostCode: (costcode) => {
            if (form) {
                ...
                if ("value" in costcode && "label" in costcode) {
                    ...
                    setForm((prev) =>
                        prev ? { ...prev, CostCode: costcode } : prev
                    );
                }
            }
        },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black-40">
            <div className="bg-white rounded-lg shadow-lg w-[600px] h-[80vh] px-6 py-4 flex flex-col items-center">
                <div className="w-full flex flex-col border-b border-gray-100 pb-3 relative">
                    {error && (
                        <div className=" text-xs text-red-600 mb-2 bg-red-400/20 px-6 py-4 rounded max-w-[700px]">
                                            ...
                                            <>
                                                ...
                                                {showMaintenance && (
                                                    <EditMechanicProjects
                                                        ...
                                                        onAddProject={
                                                            logs.addMechanicProject
                                                        }
                                                        onRemoveProject={
                                                            logs.removeMechanicProject
                                                        }
                                                        originalProjects={
                                                            originalForm?.Maintenance ||
                                                            []
                                                        }
                                                        onUndoProjectField={
                                                ...
                                                {showTrucking && (
                                                    <EditTruckingLogs
                                                        ...
                                                        addEquipmentHauled={
                                                            logs.addEquipmentHauled
                                                        }
                                                        deleteEquipmentHauled={
                                                            logs.deleteEquipmentHauled
                                                        }
                                                        addMaterial={
                                                            logs.addMaterial
                                                        }
                                                        ...
                                                        deleteRefuelLog={
                                                            logs.deleteRefuelLog
                                                        }
                                                        addStateMileage={
                                                            logs.addStateMileage
                                                        }
                                                        deleteStateMileage={
                                                            logs.deleteStateMileage
                                                        }
                                                        originalLogs={
                                                            originalForm?.TruckingLogs ||
                                                            []
                                                        }
                                                        onUndoLogField={
                                                            logs.handleUndoTruckingLogField
                                                        }
                                                ...
                                                {showTasco && (
                                                    <EditTascoLogs
                                                        ...
                                                        addTascoRefuelLog={
                                                            logs.addTascoRefuelLog
                                                        }
                                                        deleteTascoRefuelLog={
                                                            logs.deleteTascoRefuelLog
                                                        }
                                                        addTascoFLoad={
                                                            logs.addTascoFLoad
                                                        }
                                                        deleteTascoFLoad={
                                                            logs.deleteTascoFLoad
                                                        }
                                                        originalLogs={
                                                            originalForm?.TascoLogs ||
                                                            []
                                                        }
                                                        onUndoLogField={
                                                            logs.handleUndoTascoLogField
                                                        }
                                                    />
                                                )}
                                                {showEquipment && (
                                                    <EditEmployeeEquipmentLogs
                                                        ...
                                                        onAddLog={
                                                            logs.addEmployeeEquipmentLog
                                                        }
                                                        onRemoveLog={
                                                            logs.removeEmployeeEquipmentLog
                                                        }
                                                        originalLogs={
                                                ...
                                                <>
                                                    <Button
                                                        ...
                                                        className={`bg-red-200 hover:bg-red-300 text-red-800 px-4 py-2 rounded ${
                                                            ...
                                                            "REJECTED"
                                                                ? "bg-red-200/50 "
                                                                : "bg-red-200 border-red-800 hover:border-red-900 border-2"
                                                        }`}
                                                        onClick={() =>
                                                            setForm({
                                                                ...form,
                                                    ...
                                                    <Button
                                                        ...
                                                        className={`bg-green-400 hover:bg-green-300 text-green-800 px-4 py-2 rounded ${
                                                            ...
                                                            "APPROVED"
                                                                ? "bg-green-400/50 "
                                                                : "bg-green-400 border-green-800 hover:border-green-900 border-2"
                                                        }`}
                                                        onClick={() =>
                                                            setForm({
                                                                ...form,
